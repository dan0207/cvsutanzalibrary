...
<div id="chat" class="chat bg-background h-70 border border-primary border-5 border-end-0 rounded-start-5 z-2 px-3 my-5">
    <div class="chat-header bg-background text-center rounded-start-5 h-20 w-100 d-flex justify-content-center align-items-center">
    ...
    <div class="chat-body h-80 px-3 pb-3">
        <div class="chatbox border border-2 rounded-5 h-100 w-100 shadow bg-body-tertiary px-4 py-3">
                ...
                <div class="sender-chat row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="sender-message border rounded-4 p-3 fs-8 shadow-sm bg-body-surface">
                            Hi there! I’m ALI Augmented Library Interface, the after-hours A.I. chat for Cavite State University Tanza Campus Library. What can I help you with?
                        </div>
                    </div>
                </div>
                <div class="chat-faqs text-center px-5">
            ...
            <div class="input-group h-15 d-flex justify-content-center align-items-center">
                <input id="chat_messege_input" type="text" class="form-control rounded-start-pill px-3 h-80" placeholder="Message">
                <button id="chat_emoji_btn" class="input-group-text h-80 rounded-end-pill" id="basic-addon1"><i class="fa-regular fa-face-smile fa-xl"></i></button>
