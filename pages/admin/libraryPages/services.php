                    ...
                    <?php
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            while (mysqli_stmt_fetch($stmt)) {
                                ?>
                                <ul class="border mb-5">
                                    <a class="nav-link" href="../render/edit.php?page=services&id=<?php echo $mainText ?>&subText=<?php echo $subText ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <?php echo $subText; ?>
                                </ul>
                                <?php
                            }
