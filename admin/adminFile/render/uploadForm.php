...
<html lang="en">
    ...
    <body>
        ...
        <span class="position-absolute end-0"><button class="btn btn-secondary border rounded-circle me-2"><i class="fa-solid fa-xmark"></i></button></span>
            ...
            <form method="post" enctype="multipart/form-data">
                <!-- Textbox -->
                <input class="form-control" type="text" name="text" id="text" placeholder="What's on your mind?" autocomplete="off">
