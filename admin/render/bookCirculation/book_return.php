<?php
    ...
    {
        $sql = "INSERT INTO booktransaction (id, libraryid, name, courseSection, email, bookAccessNo, bookTitle, bookcallno, pickupDate, dueDate, returnDate, fine, remarks) 
                VALUES ('$id', '$libraryId', '$name', '$course', '$email', '$accessNo', '$title', '$callno', '$pickupDate', '$dueDate', '$returnDate', '$fine', 'Returned')";
